...
export function initAirlandPage() {
  // 1. Insere os CSS externos, se necessário.
  const cssFiles = [
  ...
  // 2. Cria e insere o CSS customizado, com variáveis para o tema claro/dark
  const style = document.createElement("style");
  style.textContent = `
    /* Definindo as cores da seta: no tema claro, seta escura (#444); no dark, seta branca (#fff) */
    :root {
      --arrow-color: #444;
    }
    body.dark-theme {
    ...
    /* Exemplo de estilização da seta (seta “→” antes do texto) */
    .arrow-icon {
      margin-right: 6px;
      color: var(--arrow-color);
      font-weight: bold;
    }
    /* (Outros estilos extras podem ser adicionados conforme necessário) */
    
    /* Esses estilos abaixo preservam o layout original do menu */
    .sidebar-nav a {
      display: block;
      padding: 10px 15px;
      color: #fff;
  ...
  // 3. Define o HTML que será injetado (exatamente como enviado por você)
  const htmlContent = `
    <!DOCTYPE html>
    <html lang="pt">
    <head>
          ...
          <ul>
            ...
            <li class="nav-item nav-item-has-children">
              ...
              <ul id="ddmenu_2" class="collapse dropdown-nav">
                <li>
                  <a href="pedidos.html">
                    <span class="arrow-icon">→</span> Pedidos
                  </a>
                </li>
                <li>
                  <a href="clientes.html">
                    <span class="arrow-icon">→</span> Clientes
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="nav-item nav-item-has-children">
              ...
              <ul id="ddmenu_3" class="collapse show dropdown-nav">
                <li>
                  <a href="design.html#idvisual">
                    <span class="arrow-icon">→</span> Identidade Visual
                  </a>
                </li>
                <li>
                  <a href="design.html#paleta">
                    <span class="arrow-icon">→</span> Paleta de Cores
                  </a>
                </li>
                <li>
                  <a href="design.html#banner">
                    <span class="arrow-icon">→</span> Banner
                  </a>
                </li>
                <li>
                  <a href="design.html/#footer">
                    <span class="arrow-icon">→</span> Rodapé
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="nav-item nav-item-has-children">
              ...
              <ul id="ddmenu_usuarios" class="collapse show dropdown-nav">
                <li>
                  <a href="createuser.html">
                    <span class="arrow-icon">→</span> Criar acesso
                  </a>
                </li>
                <li>
                  <a href="users.html">
                    <span class="arrow-icon">→</span> Gerenciar usuários
                  </a>
                </li>
              </ul>
            </li>
            ...
            <div class="col-md-6 order-last order-md-first">
              <div class="copyright text-center text-md-start">
                <p class="text-sm">
                  ...
                  <a href="https://airland.com.br" rel="nofollow" target="_blank">Airland</a>
                </p>
              </div>
            </div>
          </div>
  ...
  // 4. Insere o HTML completo no body – preservando exatamente o layout que você forneceu
  document.body.innerHTML = htmlContent;
  
  // 5. Configura os botões de alternância de tema (light/dark)
  ...
  // 6. Realiza a requisição para buscar os dados do usuário e atualiza os placeholders
  fetch("https://airland.com.br/affiliatesacess/login_api.php/check")
    ...
    .then(data => {
      if (data.logged_in && data.user_data) {
        ...
        // Se necessário, atualize também outros dados, como o nome da agência
      }
    })
    .catch(error => {
